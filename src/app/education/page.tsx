    ...
    <>
      ...
      <div className="font-sans">
        <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-blue-500">
          <div className="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
            <h2 className="text-gray-800 lg:text-5xl text-3xl font-bold lg:!leading-[56px]">Empowering Education Through Technology</h2>
            <p className="text-gray-800 mt-6 text-base leading-relaxed">
              At --- Solutions, we believe in the power of technology to revolutionize education.
              Our cutting-edge software solutions are designed to enhance learning experiences,
              streamline administrative processes, and foster a collaborative environment in educational
              institutions. We are committed to providing innovative tools that empower educators,
              engage students, and support the evolving needs of the education sector.
      ...
      <section className="">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-6 px-4 my-12">
          <div className="bg-gray-100 p-6 rounded-md">
            ...
            <h3 className="text-lg font-bold mb-2 text-gray-800">E-Learning Solutions</h3>
            <p className="text-sm text-gray-600">
              Our e-learning solutions provide flexible and accessible learning opportunities for 
              students of all ages. We develop interactive e-learning platforms, digital course
               materials, and assessment tools that enable remote learning and support a 
               variety of learning styles.
            </p>
          </div>
          <div className="bg-gray-100 p-6 rounded-md">

            <h3 className="text-lg font-bold mb-2 text-gray-800">Educational Content Management</h3>
            <p className="text-sm text-gray-600">
            Efficiently manage and deliver educational content with our content management
             solutions. We provide tools for creating, organizing, and distributing digital 
             content, ensuring that educators can easily 
            share resources and students can access the materials they need.
            </p>
          </div>
          <div className="bg-gray-100 p-6 rounded-md">

            <h3 className="text-lg font-bold mb-2 text-gray-800">Collaborative Learning Platforms</h3>
            <p className="text-sm text-gray-600">Foster collaboration and communication 
              among students and educators with our collaborative learning platforms. 
              These tools include discussion forums, group projects, peer assessments, 
              and real-time communication features, 
              creating a dynamic and interactive learning environment</p>
           </div>
      ...
      <section className="">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-6 px-4 my-12">
          <div className="bg-gray-100 p-6 rounded-md">
            ...
            <h3 className="text-lg font-bold mb-2 text-gray-800">Virtual Classrooms</h3>
            <p className="text-sm text-gray-600">Tailor our product to suit your needs.</p>
            <a href="javascript:void(0);" className="text-blue-600 font-bold inline-block text-sm mt-4 hover:underline">Learn more</a>
          </div>
          <div className="bg-gray-100 p-6 rounded-md">
            ...
            <h3 className="text-lg font-bold mb-2 text-gray-800">Educational Analytics</h3>
          ...
          <div className="bg-gray-100 p-6 rounded-md">
            ...
            <h3 className="text-lg font-bold mb-2 text-gray-800">AI-Driven Tutoring Systems</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-8 max-lg:max-w-2xl mx-auto">
        <div className="text-left">
          ...
          With extensive experience in the education sector,
           we understand the unique needs and challenges of educational institutions.
            Our team is dedicated to developing solutions that meet these needs and enhance
          ...
          <div className="grid xl:grid-cols-3 sm:grid-cols-2 gap-8 mt-12">
            <div className="flex items-center">
              ...
              <h6 className="text-base font-semibold ml-4">Innovation-Driven</h6>
            </div>
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" className="fill-green-500 shrink-0" viewBox="0 0 24 24">
                <path d="M9.707 19.121a.997.997 0 0 1-1.414 0l-5.646-5.647a1.5 1.5 0 0 1 0-2.121l.707-.707a1.5 1.5 0 0 1 2.121 0L9 14.171l9.525-9.525a1.5 1.5 0 0 1 2.121 0l.707.707a1.5 1.5 0 0 1 0 2.121z" data-original="#000000"></path>
              </svg>
              <h6 className="text-base font-semibold ml-4">User-Centric Design</h6>
            </div>
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" className="fill-green-500 shrink-0" viewBox="0 0 24 24">
                <path d="M9.707 19.121a.997.997 0 0 1-1.414 0l-5.646-5.647a1.5 1.5 0 0 1 0-2.121l.707-.707a1.5 1.5 0 0 1 2.121 0L9 14.171l9.525-9.525a1.5 1.5 0 0 1 2.121 0l.707.707a1.5 1.5 0 0 1 0 2.121z" data-original="#000000"></path>
              </svg>
              <h6 className="text-base font-semibold ml-4">Comprehensive Support</h6>
            </div>
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" className="fill-green-500 shrink-0" viewBox="0 0 24 24">
                <path d="M9.707 19.121a.997.997 0 0 1-1.414 0l-5.646-5.647a1.5 1.5 0 0 1 0-2.121l.707-.707a1.5 1.5 0 0 1 2.121 0L9 14.171l9.525-9.525a1.5 1.5 0 0 1 2.121 0l.707.707a1.5 1.5 0 0 1 0 2.121z" data-original="#000000"></path>
