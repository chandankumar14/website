        ...
        <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-blue-500">
          <div className="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
            ...
            <p className="text-gray-800 mt-6 text-base leading-relaxed ">
              At --- Solutions, we believe in the power of technology to
              revolutionize education. Our cutting-edge software solutions are
              designed to enhance learning experiences, streamline
              administrative processes, and foster a collaborative environment
              in educational institutions. We are committed to providing
              innovative tools that empower educators, engage students, and
              support the evolving needs of the education sector.
            </p>
          </div>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-6 px-4 my-12">
          <div className="bg-gray-100 p-6 rounded-md">
            ...
            <p className="text-sm text-gray-600">
              Our e-learning solutions provide flexible and accessible learning
              opportunities for students of all ages. We develop interactive
              e-learning platforms, digital course materials, and assessment
              tools that enable remote learning and support a variety of
              learning styles.
            </p>
          </div>
          <div className="bg-gray-100 p-6 rounded-md">
            ...
            <p className="text-sm text-gray-600">
              Efficiently manage and deliver educational content with our
              content management solutions. We provide tools for creating,
              organizing, and distributing digital content, ensuring that
              educators can easily share resources and students can access the
              materials they need.
            </p>
          </div>
          <div className="bg-gray-100 p-6 rounded-md">
