...
export default function FooterSection(){
  ...
  <h6 className="text-base text-gray-300 text-[15px] transition-al">Stay connected with us:</h6>
  ...
  <p className="text-base text-gray-300 text-[15px] transition-al">&copy; 2023<a href='https://readymadeui.com/' target='_blank'
    className="hover:underline mx-2 text-gray-300 text-[15px] transition-al">ReadymadeUI</a>All Rights Reserved.</p>
</div>
      </div>
    </footer>
        </>
