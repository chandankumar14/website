...
export default function OurValuePage() {
    return (
        <>
            ...
            <section className="bg-custom-color mt-4 px-12 bg-gray-100">
                <h1 className="text-center py-4  text-blue-600 italic  text-4xl">Our Values</h1>
                <p className="text-center text-black italic text-4xl">What we value most</p>
                <div className="grid lg:grid-cols-3 md:grid-cols-2 mt-2">
                    <div className="shadow-lg px-12 bg-white mb-4 ml-4">
                        ...
                        />
                        <p className="text-blue-400 text-center italic text-3xl">Integrity</p>
                        <p className="text-start text-lg text-gray-600 font-extralight py-4">We believe in transparency, honesty, and building trust with our clients through every interaction</p>
                    </div>
                    ...
                    <div className="shadow-lg px-12 bg-white mb-4 ml-4">
                        <Image className="lg:py-0"
                            ...
                            alt="Picture of the author"
                        />
                        <p className="text-blue-400 text-center  text-3xl italic">Innovation</p>
                    ...
                    <div className="shadow-lg px-12 bg-white mb-4 ml-4">
                        <Image className="lg:py-0"
                            ...
                            alt="Picture of the author"
                        />
                        <p className="text-blue-400 text-center text-3xl italic">Commitment</p>
