                ...
                <div className='w-full flex flex-wrap items-center justify-center gap-6 px-10 py-0 '>
                    ...
                    <div id="collapseMenu"
                        ...
                        <ul
                            ...
                            <li className='max-lg:border-b max-lg:px-3 max-lg:py-2'><a href='javascript:void(0)'
                                className='hover:text-[#007bff] text-gray-500 font-bold text-[15px] block'>Contact</a></li>
                            <li className='max-lg:border-b max-lg:px-3 max-lg:py-2'><a href='javascript:void(0)'
                                className='hover:text-[#007bff] text-gray-500 font-bold text-[15px] block'>Source</a></li>
                            <li className='max-lg:border-b max-lg:px-3 max-lg:py-2'><a href='javascript:void(0)'
